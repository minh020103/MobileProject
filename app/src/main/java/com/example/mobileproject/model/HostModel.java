...
public class HostModel {
    ...
    public HostModel(int id, int idTaiKhoan, String hinhNguoiDung, String tenNguoiDung, String soDienThoai, String gioiTinh, int idDichVu, String soTaiKhoanNganHang, String tenChuTaiKhoanNganHang, int xacThuc) {
        this.id = id;
